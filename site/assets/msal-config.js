...
export const AZURE_TENANT_ID = 'dfc22d3a-9773-49e8-b017-a5d7a5fee3dd';

// Must also be registered as a Single-page application redirect URI in Microsoft Entra.
// For the current GitHub Pages deployment, the site origin is used.
export const MSAL_REDIRECT_URI = window.location.origin;
