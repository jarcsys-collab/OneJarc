...
function toCatalogEntry(record, index) {
  ...
  const name = cleanString(record.toolName);
  ...
  const category = cleanString(record.category, "Uncategorized") || "Uncategorized";
  ...
  const draft = {
    ...
    openBehavior: record.tab === "same-tab" ? "same-tab" : "new-tab",
    documentationUrl: "",
    supportUrl: "",
    statusUrl: "",
    accessType: "Open",
